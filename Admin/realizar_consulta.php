        ...
        <div class="side-inner">
            ...
            <div class="nav-menu">
                <ul>
                    ...
                    <li><a href="/sistema_de_cita_odontologica-main/admin/inicioAdmin.php"><span class="icon-location-arrow mr-3"></span> <i class="far fa-calendar-check"></i>
                            Citas
                            pendientes
                        </a></li>
                                            ...
                                            <div class=" form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2 col-md-offset-5">
                                                        <a href="sistema_de_cita_odontologica-main/admin/inicioAdmin.php"> <i class="fas fa-history"></i> Atrás </a>
                                                    </div>
                                                </div>
