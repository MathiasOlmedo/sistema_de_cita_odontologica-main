...
<head>
  <meta charset="utf-8">
  <title>Perfect Teeth – Mis Presupuestos</title>
    ...
    <header class="topbar">
      <div class="container-max d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-2">
          <i class="fa fa-file-text-o" style="color:#0d6efd;"></i>
          <span style="font-weight:600;">Mis Presupuestos</span>
        </div>
      </div>
    </header>
      ...
      <div class="container-max">
        ...
        <div class="card">
          <div class="card-header-custom">
            <h3><i class="fa fa-file-text"></i> Historial de Presupuestos</h3>
          ...
          <div style="padding:1.5rem;">
            <?php if (empty($presupuestos)): ?>
              <div style="text-align:center; padding:3rem; color:#999;">
                <i class="fa fa-file-text-o" style="font-size:4rem; margin-bottom:1rem;"></i>
                <h4>No tienes presupuestos registrados</h4>
                <p>Los presupuestos aparecerán aquí una vez que el doctor los genere</p>
              </div>
            <?php else: ?>
                ...
                <table class="table-modern">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-success"><strong>Gs <?php echo number_format($p['pagado'], 0, ',', '.'); ?></strong></td>
                      ...
                      <td>
                        <?php if (!empty($p['pdf_path'])): ?>
                          <a href="<?php echo htmlspecialchars($p['pdf_path']); ?>" target="_blank" class="btn-gradient">
