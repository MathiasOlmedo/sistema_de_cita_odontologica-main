...
if (session_status() === PHP_SESSION_NONE) {
    session_start();
} // Necesario para usar $_SESSION (mensajes, login, etc.)
...
$isLoggedIn = isset($_SESSION['id_paciente']);  // ¿usuario autenticado?

if ($isLoggedIn) {
    $vUsuario = $_SESSION['id_paciente'];
    $row = consultarPaciente($link, $vUsuario);
    // $row tendrá los datos del paciente si los necesitas en el HTML
}
// OJO: Ya no redirigimos si no hay sesión; esta página es pública.
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
          ...
          <div class="container">
               <div class="navbar-header">
                    ...
                    <a href="principal.php" class="navbar-brand">
                         <img src="src/img/logo.png" width="20" height="20" alt="Logo">
                    </a>
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <?php if ($isLoggedIn): ?>
                           <li class="appointment-btn"><a href="#appointment" class="smoothScroll">Realizar una Cita</a></li>
                         <?php else: ?>
     ...
     <div class="row">
          <div class="col-md-3 col-md-offset-5">
               <?php if (!empty($_SESSION['MensajeTexto'])): ?>
                    <div class="alert <?php echo $_SESSION['MensajeTipo'] ?? 'alert-info'; ?>" role="alert">
                         <?php
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="about-info">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   ...
                                   <h5>Visión</h5>
                                   <p>Ser la institución líder en servicios odontológicos a nivel nacional y América Latina; logrando la expansión de las coberturas, la mejora continúa de los procesos y garantizando calidad y profesionalidad.</p>
                                   <h5>Misión</h5>
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <?php else: ?>
                           ...
                           <div class="alert alert-info" style="margin-top:15px">
                                Para agendar en línea, <a href="login.php">inicia sesión</a> o <a href="registro.php">crea tu cuenta</a>.
                                También puedes llamarnos al <strong>+1 (849) 856 4014</strong>.
                           </div>
                         <?php endif; ?>
                    </div>
               </div>
     ...
     <section id="google-map">
          <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d901.4595953705438!2d-57.51119473043212!3d-25.34320378656389!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjXCsDIwJzM1LjUiUyA1N8KwMzAnMzguMCJX!5e0!3m2!1ses!2spy!4v1743518779941!5m2!1ses!2spy"
                              ...
                              <div class="latest-stories">
                                   <div class="stories-image">
                                        <a href="https://www.odontologos.mx/odontologos/noticias/3407/como-ha-evolucionado-la-odontologia-moderna" target="_blank">
                                             <img src="src/img/evolucion.jpg" class="img-responsive" alt="">
                                        </a>
                                   </div>
                                   <div class="stories-info">
                                        <a href="https://www.odontologos.mx/odontologos/noticias/3407/como-ha-evolucionado-la-odontologia-moderna" target="_blank">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb">
                              ...
                              <ul class="social-icon">
                                   <li>
                                     <a href="https://www.facebook.com/Perfect-Teeth-111123294536780" target="_blank" class="fa fa-facebook-square" attr="facebook icon"></a>
                                   </li>
                              </ul>
                         </div>
                    </div>
     ...
     <script>
          // Evita duplicar el mismo listener
          document.addEventListener('DOMContentLoaded', () => {
               (document.querySelectorAll('.alert .delete') || []).forEach(($delete) => {
                    const $notification = $delete.parentNode;
                    $delete.addEventListener('click', () => {
